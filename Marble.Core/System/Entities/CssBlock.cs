...
namespace Marble.Core.System.Entities
{
	/// <summary>
	...
	public sealed class CssBlock
	{
		...
		public CssBlock(string @class, Dictionary<string, string> properties,
			List<CssBlockSelectorItem> selectors = null, bool hover = false)
		{
