...
namespace Marble.Core.System.Utils
{
	...
	internal sealed class DomUtils
	{
		...
		/// <param name="styleGen">Controls the way styles are generated when html is generated</param>
		private static void WriteHtmlTag(CssParser cssParser, StringBuilder sb, CssBox box,
		...
		private static string GetSelectedWord(CssRect rect, bool selectedText)
		{
			...
			{
				return rect.Text.Substring(rect.SelectedStartIndex,
					rect.SelectedEndIndexOffset - rect.SelectedStartIndex);
			}
